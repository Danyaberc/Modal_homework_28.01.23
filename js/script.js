...
let btn_mod = document.querySelector('.button_modal');

let modal = document.querySelector('.block_modal');

let closeimg = document.querySelector('.close_block');

closeimg.addEventListener('click', () => {
   modal.classList.remove('berc');
})

btn_mod.addEventListener('click', () => {
   modal.classList.add('berc');
...
function multiply() {
   sum.innerHTML = fullsum * d / coursevalue;
   //------Функція кількість на ціну
}
